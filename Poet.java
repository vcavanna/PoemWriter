...
class Poet{
  static DSArrayList<Word> Words;  // Will hold words from the book
   ...
   */
  private static boolean stressesMatch(String needs, DSArrayList<Integer> proposedWord){
  ...
  static Word findWordMatchingStressesAndPhonemes(String meter, DSArrayList<String> rhymeNeeds){
